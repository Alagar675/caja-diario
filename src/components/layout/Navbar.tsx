...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full backdrop-blur-sm bg-white/90 dark:bg-dark/90 border-b">
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center">
          <a href="/dashboard" className="flex items-center space-x-2">
            <span className="text-2xl font-bold text-primary">FinanzApp</span>
          </a>
        </div>
      ...
      <div
        className={cn(
          "md:hidden absolute w-full bg-white/95 backdrop-blur-sm border-b border-border",
